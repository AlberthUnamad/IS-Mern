      ...
      (<div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          ...
          <span className="hotelPriceHighlight">
            Reserve una estadía por más de ${data.cheapestPrice} en la propiedad y obtenga un taxi gratuito al aeropuerto
          </span>
          ...
          <div className="hotelDetails">
            ...
            <div className="hotelDetailsPrice">
              ...
              <span>
                Esta propiedad esta en una excelente ubicacion cerca al centro de la ciudad!
              </span>
              <h2>
