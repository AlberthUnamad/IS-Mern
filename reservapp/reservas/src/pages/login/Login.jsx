...
const Login = () => {
    ...
    return (
        <div className="container-login">
            <div className="main">
                <input className="IN" type="checkbox" id="label" arias-hidden="true"/>
            <div className="login">
                <label for="label">Iniciar Sesion</label>
                    <input type="text" placeholder="Nombre de usuario" id="username" className="lInput IN" 
                    onKeyUp={(e)=>e.key==="Enter"? login(e):""}
                    onChange={handleChange}
                    />
                    <input type="password" placeholder="Contraseña" id="password" className="lInput IN" 
                    onKeyUp={(e)=>e.key==="Enter"? login(e):""}
                    onChange={handleChange}
                    />
