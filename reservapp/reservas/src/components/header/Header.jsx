        ...
        {type !== "list" && (
          <>
            ...
            <p className="headerDesc">
              Reciba recompensas por sus viajes: desbloquee ahorros instantáneos del 10 % o más con una cuenta gratuita de Lamabooking
            </p>
            {!user && <button className="headerBtn">Iniciar Sesion / Registror</button>}
